          ...
          <div className="container mx-auto px-5">
            <div className="flex flex-wrap">
               <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
                    <div className="border-2 hover:shadow-xl hover:shadow-gray-300 p-5 text-center bg-gray-100 px-4 py-6" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : null, color: mode === 'dark' ? 'white' : null, }} >
