...
function Footer() {
  ...
  return (
    <>
      <footer className=' text-gray-600  bg-gray-300' style={{ color: mode === 'dark' ? 'white' : '',  backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '' }} >
        <div className="container mx-auto  px-5 py-24">
          <div className="flex flex-wrap md:text-left text-center order-first">
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
               <h2 className=' text-gray-800 font-bold text-lg mb-5 ' style={{ color: mode === 'dark' ? 'white' : '' }}>Categories</h2>
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
               <h2 className=' text-gray-800 font-bold text-lg mb-5 ' style={{ color: mode === 'dark' ? 'white' : '' }}>Customer Service</h2>
               <nav className=' list-none mb-10 font-semibold'>
                 <li>
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
               <h2 className=' text-gray-800 font-bold text-lg mb-5 ' style={{ color: mode === 'dark' ? 'white' : '' }}>Services</h2>
               <nav className=' list-none mb-10 font-semibold'>
                 <li>
        ...
        <div className="bg-gray-200" style={{ backgroundColor: mode === 'dark' ? 'rgb(55 57 61)' : '', color: mode === 'dark' ? 'white' : '', }}>
                <div className="container px-5 py-3 mx-auto flex items-center sm:flex-row flex-col">
                    ...
                    <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
                        <a className="text-gray-500 hover:text-blue-700 hover:scale-125 transition transform" style={{ color: mode === 'dark' ? 'white' : '' }}>
                            <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} className="w-5 h-5" viewBox="0 0 24 24">
                                <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z" />
                            </svg>
                        </a>
                        <a className="ml-8 text-gray-500  hover:text-blue-700 hover:scale-125 transition transform " style={{ color: mode === 'dark' ? 'white' : '' }}>
                            <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} className="w-5 h-5" viewBox="0 0 24 24">
